...
class AdvSummary(models.Model):
    ...
    adv_desc = models.CharField(max_length=255, null=False, verbose_name='Advertisement Description')
    adv_min_follower = models.IntegerField(null=False, verbose_name='Advertisement Minimum Follower')
    adv_max_follower = models.IntegerField(null=False, verbose_name='Advertisement Maximum Follower')
